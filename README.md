...
FairCroft CoreOne includes mobile PWA basics:
...
- install prompt hook for browsers that support `beforeinstallprompt`
- iPhone install hint for Safari: Share -> Add to Home Screen
